...
<p align="center"><strong><code>@dootix-developer/photoviewer</code></strong></p>
<br>
...
<p>As previously mentioned, this repository had reason to exist only until the upstream repository was updated. Considering that this condition has now occurred, this repository has been archived. Please use https://github.com/capacitor-community/photoviewer.
</p>
<br>
<br>
<p align="left">
...
```bash
npm install @dootix-developer/photoviewer
npx cap sync
```
